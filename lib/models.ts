...
const models: Model[] = [
  ...
  },
  {
    ...
    name: "GPT-5.2",
    provider: "openai",
    description: "Broad and steady, and it can look things up.",
    capabilities: ["reasoning", "vision", "tools", "search", "code"],
  ...
  },
  {
    ...
    name: "GPT-5.2 mini",
    provider: "openai",
    description: "The same shape, smaller and cheaper to run.",
    capabilities: ["vision", "tools"],
    contextWindow: 400_000,
    tier: "free",
  },
  ...
  },
  {
    ...
    name: "DeepSeek R1",
    provider: "deepseek",
    description: "Open reasoning, and it shows its working.",
  ...
  },
  {
    ...
    name: "DeepSeek V3.2",
    provider: "deepseek",
    description: "The general one, priced to be left running.",
  ...
  },
  {
    ...
    provider: "meta",
    description: "Open weights, so it runs wherever it is needed.",
  ...
  },
  {
    ...
    name: "Kimi K2",
    provider: "moonshot",
    description: "Built for agents, and it holds a long thread.",
    capabilities: ["tools", "code"],
    contextWindow: 256_000,
    tier: "free",
  },
